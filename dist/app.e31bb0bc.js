...
},{"../level.txt":"level.txt","./sprite":"lib/sprite.js"}],"lib/ui.js":[function(require,module,exports) {
"use strict";
...
game.on("draw", function (ctx, dt) {
  ...
  (0, _sprite.animateSprite)(ctx, "wizzard_m_idle_anim", 140, 340);
  (0, _sprite.animateSprite)(ctx, "ogre_idle_anim", 420, 340, true);
  (0, _ui.default)(ctx);
});
game.start();
