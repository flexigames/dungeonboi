...
function createWallBottomTile(x, y) {
  return [
    createSprite("wall_mid", x * TILE_SIZE, y * TILE_SIZE, { anchor: [0, 1], zIndex: y * TILE_SIZE + 2}),
    createSprite("wall_top_mid", x * TILE_SIZE, (y - 1) * TILE_SIZE, { anchor: [0, 1], zIndex: y * TILE_SIZE + 2}),
  ]
}

function createWallCornerBottomLeftTile(x, y) {
  return [
    createSprite("wall_corner_front_left", x * TILE_SIZE, y * TILE_SIZE, { anchor: [0, 1], zIndex: y * TILE_SIZE + 2}),
    createSprite("wall_corner_bottom_left", x * TILE_SIZE, (y - 1) * TILE_SIZE, { anchor: [0, 1], zIndex: y * TILE_SIZE + 2}),
  ]
}

function createWallCornerBottomRightTile(x, y) {
  return [
    createSprite("wall_corner_front_right", x * TILE_SIZE, y * TILE_SIZE, { anchor: [0, 1], zIndex: y * TILE_SIZE + 2}),
    createSprite(
      "wall_corner_bottom_right",
      x * TILE_SIZE,
      (y - 1) * TILE_SIZE,
      { anchor: [0, 1], zIndex: y * TILE_SIZE + 2}
    ),
  ]
}
...
function createWallInnerLeftTopCorner(x, y) {
  return [
    createSprite("floor_1", x * TILE_SIZE, y * TILE_SIZE),
    createSprite("wall_side_mid_right", x * TILE_SIZE, (y) * TILE_SIZE),
    createSprite("wall_side_mid_right", x * TILE_SIZE, (y - 1) * TILE_SIZE, {zIndex: y * TILE_SIZE + 2}),
    createSprite("wall_side_top_right", x * TILE_SIZE, (y - 2) * TILE_SIZE, {zIndex: y * TILE_SIZE + 2}),
  ]
}
...
function createWallInnerRightTopCorner(x, y) {
  return [
    createSprite("floor_1", x * TILE_SIZE, y * TILE_SIZE),
    createSprite("wall_side_mid_left", x * TILE_SIZE, y * TILE_SIZE),
    createSprite("wall_side_mid_left", x * TILE_SIZE, (y - 1) * TILE_SIZE, {zIndex: y * TILE_SIZE + 2}),
    createSprite("wall_side_top_left", x * TILE_SIZE, (y - 2) * TILE_SIZE, {zIndex: y * TILE_SIZE + 2}),
  ]
}
