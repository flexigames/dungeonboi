...
function createFloorsAndWalls(tiles) {
  ...
  function createLevelSprite(name, x, y, opts = {}) {
    return createSprite(name, x, y, {...opts, stage: container})
  }
  ...
  function createWallInnerRightCorner(x, y) {
    return [
      createLevelSprite("floor_1", x * TILE_SIZE, y * TILE_SIZE),
      createLevelSprite("wall_side_front_left", x * TILE_SIZE, y * TILE_SIZE),
    ]
  }
  ...
  function createWallInnerLeftCorner(x, y) {
    return [
      createLevelSprite("floor_1", x * TILE_SIZE, y * TILE_SIZE),
      createLevelSprite("wall_side_front_right", x * TILE_SIZE, y * TILE_SIZE),
    ]
  }
  ...
  function createFloorTile(x, y) {
    ...
    const sprite = createLevelSprite("floor_" + id, x * TILE_SIZE, y * TILE_SIZE)

    if (id == 1 && Math.random() < 0.01) {
      const skull = createLevelSprite("skull", x * TILE_SIZE + random(-2, 2), y * TILE_SIZE + random(-2, 2))
  ...
  function createWallTopTile(x, y, tile, bannerColor) {
    ...
    return [
      createLevelSprite("wall_top_mid", x * TILE_SIZE, (y - 1) * TILE_SIZE),
      createLevelSprite("wall_mid", x * TILE_SIZE, y * TILE_SIZE),
    ]
  }
  ...
  function createRandomDecoratedWallTopTile(x, y, bannerColor) {
    ...
    return compact([
      createLevelSprite("wall_top_mid", x * TILE_SIZE, (y - 1) * TILE_SIZE),
      createLevelSprite(sprite, x * TILE_SIZE, y * TILE_SIZE),
      sprite === 'wall_goo' && createLevelSprite('wall_goo_base', x * TILE_SIZE, (y + 1) * TILE_SIZE, {zIndex: y * TILE_SIZE})
    ])
  ...
  function createFountainWall(x, y) {
    return [
      createLevelSprite("wall_fountain_top", x * TILE_SIZE, (y - 1) * TILE_SIZE),
      createLevelSprite("wall_fountain_mid_red_anim", x * TILE_SIZE, y * TILE_SIZE),
      createLevelSprite("wall_fountain_basin_red_anim", x * TILE_SIZE, (y +1) * TILE_SIZE, {zIndex: y * TILE_SIZE}),
    ] 
  }
  ...
  function createWallTopTileColumn(x, y) {
    return [
      createLevelSprite("wall_column_base", x * TILE_SIZE, (y + 2) * TILE_SIZE, {
        anchor: [0, 1],
        zIndex: y * TILE_SIZE + 1,
      }),
      createLevelSprite("wall_column_mid", x * TILE_SIZE, (y + 1) * TILE_SIZE, {
        anchor: [0, 1],
        zIndex: y * TILE_SIZE + 1,
      }),
      createLevelSprite("wall_column_top", x * TILE_SIZE, y * TILE_SIZE, {
        anchor: [0, 1],
        zIndex: y * TILE_SIZE +1,
      }),
    ]
  ...
  function createWallCornerTopLeftTile(x, y) {
    return [
      createLevelSprite("wall_corner_left", x * TILE_SIZE, y * TILE_SIZE),
      createLevelSprite("wall_corner_top_left", x * TILE_SIZE, (y - 1) * TILE_SIZE),
    ]
  }

  function createWallCornerTopRightTile(x, y) {
    return [
      createLevelSprite("wall_corner_right", x * TILE_SIZE, y * TILE_SIZE),
      createLevelSprite("wall_corner_top_right", x * TILE_SIZE, (y - 1) * TILE_SIZE),
    ]
  }
  ...
  function createWallLeftTile(x, y) {
    return [
      createLevelSprite("floor_1", x * TILE_SIZE, y * TILE_SIZE),
      createLevelSprite("wall_side_mid_right", x * TILE_SIZE, y * TILE_SIZE),
    ]
  }
  ...
  function createWallRightTile(x, y) {
    return [
      createLevelSprite("floor_1", x * TILE_SIZE, y * TILE_SIZE),
      createLevelSprite("wall_side_mid_left", x * TILE_SIZE, y * TILE_SIZE),
    ]
  }
  ...
  function createWallBottomTileColumn(x, y) {
    return [
      createLevelSprite("column_base", x * TILE_SIZE, (y + 1) * TILE_SIZE, {
        anchor: [0, 1],
        zIndex: y * TILE_SIZE + 1,
      }),
      createLevelSprite("wall_column_mid", x * TILE_SIZE, y * TILE_SIZE, {
        anchor: [0, 1],
        zIndex: y * TILE_SIZE + 1,
      }),
      createLevelSprite("wall_column_top", x * TILE_SIZE, (y - 1) * TILE_SIZE, {
        anchor: [0, 1],
        zIndex: y * TILE_SIZE +1,
      }),
    ]
  ...
  function createWallCornerBottomLeftTile(x, y) {
    return [
      createLevelSprite("wall_corner_front_left", x * TILE_SIZE, y * TILE_SIZE, {
        anchor: [0, 1],
        zIndex: y * TILE_SIZE + 1,
      }),
      createLevelSprite(
  ...
  function createWallCornerBottomRightTile(x, y) {
    return [
      createLevelSprite("wall_corner_front_right", x * TILE_SIZE, y * TILE_SIZE, {
        anchor: [0, 1],
        zIndex: y * TILE_SIZE + 1,
      }),
      createLevelSprite(
  ...
  function createWallInnerLeftTopCorner(x, y) {
    return [
      createLevelSprite("floor_1", x * TILE_SIZE, y * TILE_SIZE),
      createLevelSprite("wall_side_mid_right", x * TILE_SIZE, y * TILE_SIZE),
      createLevelSprite("wall_side_mid_right", x * TILE_SIZE, (y - 1) * TILE_SIZE, {
        zIndex: y * TILE_SIZE,
      }),
      createLevelSprite("wall_side_top_right", x * TILE_SIZE, (y - 2) * TILE_SIZE, {
        zIndex: y * TILE_SIZE,
      }),
    ]
  }
  ...
  function createWallInnerRightTopCorner(x, y) {
    return [
      createLevelSprite("floor_1", x * TILE_SIZE, y * TILE_SIZE),
      createLevelSprite("wall_side_mid_left", x * TILE_SIZE, y * TILE_SIZE),
      createLevelSprite("wall_side_mid_left", x * TILE_SIZE, (y - 1) * TILE_SIZE, {
        zIndex: y * TILE_SIZE,
      }),
      createLevelSprite("wall_side_top_left", x * TILE_SIZE, (y - 2) * TILE_SIZE, {
        zIndex: y * TILE_SIZE,
      }),
    ]
  }
